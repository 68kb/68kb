...
class Front_Controller extends MY_Controller
{
	...
	{
		$lang_file = 'front_lang';
		
		$theme = ROOTPATH .'themes/'.$this->settings->get_setting('site_theme').'/';
		$default = ROOTPATH .'themes/default/';
		...
		if (file_exists($theme.'language/'.$idiom.'/'.$lang_file . EXT))
		{
			$this->lang->load('front', '', FALSE, TRUE, $theme);
		}
		else
		{
			$this->lang->load('front', '', FALSE, TRUE, $default);
		}
	}
}
