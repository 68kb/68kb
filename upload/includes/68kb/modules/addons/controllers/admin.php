...
class Admin extends Admin_Controller {
	...
	*/
	...
	{	
		...
		$data['active'] = $this->addons_model->load_active();
		$this->benchmark->mark('load_active_end');
		
		$this->benchmark->mark('load_inactive_start');
		$data['inactive'] = $this->addons_model->load_inactive();
		...
		$this->template->build('admin/modules_grid', $data);
	}
	...
	*/
	...
	public function delete()
	{
		...
		$data['module_directory'] = $this->uri->rsegment(3);
		...
		{
			$this->template->build('admin/modules_delete', $data);
		}
		else
		{
	...
	*/
	...
	{	
		...
		if ($file)
		{
			...
			$this->template->build('admin/docs', $data);
		}
		else
		{
			redirect('admin/addons');
