...
class Admin extends Admin_Controller
{
	...
	public function listings()
	{
		...
		$this->form_validation->set_rules('checkout_renewal_days', 'lang:lang_renewal', 'numeric');
		$this->form_validation->set_rules('checkout_allowed_html', 'lang:lang_email', 'trim');
				
		// Call any events
		$this->events->trigger('listing_settings/validation');
		
		if ($this->form_validation->run() == FALSE)
		{
			$this->template->build('admin/listings', $data); 
		}
		else
		{
			$this->events->trigger('listing_settings/save', $_POST);
			...
			$this->session->set_flashdata('msg', lang('lang_settings_saved'));
			redirect('admin/settings/listings');
		}
	}
	// ------------------------------------------------------------------------
	...
	public function email()
	{
		...
		$this->form_validation->set_rules('protocol', 'lang:lang_email_protocol', 'required');
		$this->form_validation->set_rules('mailpath', 'lang:lang_email_mailpath', 'trim');
		$this->form_validation->set_rules('smtp_host', 'lang:lang_email_smtp_host', 'trim');
		$this->form_validation->set_rules('smtp_user', 'lang:lang_email_smtp_user', 'trim');
		$this->form_validation->set_rules('smtp_pass', 'lang:lang_email_smtp_pass', 'trim');
		$this->form_validation->set_rules('smtp_port', 'lang:lang_email_smtp_port', 'trim');
		$this->form_validation->set_rules('smtp_timeout', 'lang:lang_email_smtp_timeout', 'numeric|trim');
		$this->form_validation->set_rules('wordwrap', 'lang:lang_email_wordwrap', 'trim');
		$this->form_validation->set_rules('wrapchars', 'lang:lang_email_wrapchars', 'numeric|trim');
		$this->form_validation->set_rules('mailtype', 'lang:lang_email_mailtype', 'trim');
		$this->form_validation->set_rules('charset', 'lang:lang_email_charset', 'trim');
		$this->form_validation->set_rules('validate', 'lang:lang_badwords', 'trim');
		$this->form_validation->set_rules('priority', 'lang:lang_badwords', 'trim');
		...
		if ($this->form_validation->run() == FALSE)
		{
			$this->template->build('admin/email', $data); 
		}
		else
		{
			$this->events->trigger('settings/email/save', $_POST);
