...
class Admin extends Admin_Controller {
	...
	*/
	public function index()
	{
		...
		$data['header'] = '<script type="text/javascript" src="'.site_url('admin/js/load/').'"></script>';
		
		$this->benchmark->mark('get_admin_tree_start');
	
		$data['categories'] = $this->_cat_data;
		
		$this->benchmark->mark('get_admin_tree_end');
		
		$this->template->build('admin/category_grid', $data); // Pass off to core_template for view
	}
	...
	*/
	public function edit()
	{
		...
		$data['cat'] = $this->categories_model->get_cat($data['id'], TRUE);
		
		// Remove uri string
		$uri = explode('/', $data['cat']['cat_uri']);
		$data['cat']['cat_uri'] = array_pop($uri);
	...
	*/
	public function add()
	{
		...
		$data['cat'] = array('cat_name' => '', 'cat_uri' => '', 'cat_description' => '', 'cat_image' => '', 'cat_allowads' => '','cat_parent' => '','cat_display' => '', 'cat_order' => '', 'cat_keywords' => '', 'cat_promo' => '',
		);
	...
	*/
	public function duplicate($cat_id)
	{
		...
		$data['cat'] = $this->categories_model->get_cat($cat_id, TRUE);
