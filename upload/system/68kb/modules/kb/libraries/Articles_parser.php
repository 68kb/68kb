...
class Articles_parser
{
	...
	*/
	function get($data = array())
	{
		...
		$defaults = array('limit' => '', 'author' => '', 'category' => '', 'class' => '', 'extra_field' => '', 'sort_order' => 'asc', 'sort_column' => 'article_title', 'cache' => 0, 'where' => '', 'exclude' => '', 'per_page' => '', 'num_links' => '');
		...
		$config['num_links'] = $options['num_links'];
		if ($config['num_links'] == '')
		{
			$config['num_links'] = 2;
		}
